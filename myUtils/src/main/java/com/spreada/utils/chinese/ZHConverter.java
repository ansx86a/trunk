    ...
    public static ZHConverter getInstance(int converterType) {
        if (converterType >= 0 && converterType < 2) {
            if (converters[converterType] == null) {
               // synchronized(class$com$spreada$utils$chinese$ZHConverter == null ? (class$com$spreada$utils$chinese$ZHConverter = class$("com.spreada.utils.chinese.ZHConverter")) : class$com$spreada$utils$chinese$ZHConverter) {
                    if (converters[converterType] == null) {
            ...
            do {
                if (!iter.hasNext()) {
                    ...
                    while(iter.hasNext()) {
                        ...
                        if ((Integer)((Integer)stringPossibilities.get(key)) > 1) {
